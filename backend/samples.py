...
ADVERSARIAL: list[Sample] = [
    Sample(
        id='adv_authority', label="Authority impersonation + 'ignore warnings'",
        kind='call_transcript', region_hint='IN',
        expect_archetype='impersonation_authority', expect_scam=True,
    ...
    Sample(
        id='adv_injection', label='Prompt-injection (treated as data)',
        kind='sms', region_hint=None,
        expect_archetype='phishing_account', expect_scam=True,
    ...
    Sample(
        id='adv_lookalike', label='Look-alike domain bank phish',
        kind='sms', region_hint=None,
        expect_archetype='phishing_account', expect_scam=True,
...
_BY_ID = {s.id: s for s in SAMPLES + ADVERSARIAL}
...
DEMO_ADVERSARIAL_IDS = ["adv_lookalike", "adv_injection", "adv_authority"]
