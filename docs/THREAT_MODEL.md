...
| T4 | **False accusation of a legitimate message.** | High-precision deterministic layer + a genuine "no strong signals" outcome; a legitimate control set the eval gates on (0 false positives). | `eval/run_eval.py`, `tests/test_pipeline.py` |
